      ...
      <div className="p-5 rounded-2xl bg-vault-surface border border-vault-border">
        ...
        <Alert className="mb-4 bg-vault-hover border-vault-border">
          ...
          <AlertDescription className="text-vault-muted text-sm">
            Browser-based PDF encryption has limitations. For strong AES-256
            encryption, use Adobe Acrobat or a dedicated tool. This tool
            re-saves the PDF with metadata.
          </AlertDescription>
        </Alert>
        <FileUploadZone
