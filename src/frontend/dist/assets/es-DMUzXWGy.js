const es = {
  ...
  "hero.subtitle": "Fusiona, divide, comprime y administra tus archivos PDF con facilidad. Todas las herramientas en un solo lugar.",
  "hero.cta": "Comenzar",
  ...
  "tool.split.desc": "Extraer páginas específicas o dividir documentos en archivos separados",
  "tool.compress.label": "Comprimir PDFs",
  "tool.compress.desc": "Reducir el tamaño del archivo manteniendo la calidad",
  "tool.protect.label": "Proteger PDFs",
  "tool.protect.desc": "Añadir o eliminar protección con contraseña de tus documentos",
  ...
  "tool.converter.desc": "Convertir PDF a hoja de cálculo Excel o imágenes JPG/PNG",
  ...
  "tool.watermark.desc": "Superponer texto de marca de agua personalizado en tu PDF",
  "tool.crop.label": "Recortar PDF",
  "tool.crop.desc": "Recorta los márgenes de cada página de tu PDF con precisión.",
  "tool.flatten.label": "Aplanar formularios PDF",
  "tool.flatten.desc": "Convierte los campos de formulario interactivos en contenido estático no editable.",
  "feature.easy.title": "Fácil de usar",
  "feature.easy.desc": "Interfaz simple e intuitiva para todas tus necesidades PDF",
  "feature.secure.title": "Seguro y Privado",
  "feature.secure.desc": "Tus archivos se procesan de forma segura y nunca se comparten",
  "feature.powerful.title": "Herramientas Potentes",
  "feature.powerful.desc": "Herramientas PDF de grado profesional a tu alcance",
  ...
  "login.subtitle": "Fusiona, divide, comprime y administra tus archivos PDF con facilidad. Todas las herramientas en un solo lugar.",
  ...
  "faq.subheading": "Todo lo que necesitas saber sobre PDF Vaulty",
  "faq.q1": "¿Es gratuito PDF Vaulty?",
  "faq.a1": "Sí, PDF Vaulty es completamente gratuito. Todas las herramientas PDF están disponibles sin costo.",
  "faq.q2": "¿Son seguros mis archivos PDF?",
  "faq.a2": "Tus archivos se procesan completamente en tu navegador. Nunca los almacenamos ni compartimos.",
  "faq.q3": "¿Necesito crear una cuenta?",
  "faq.a3": "No se necesita cuenta para usar la mayoría de las herramientas. El inicio de sesión es opcional.",
  "faq.q4": "¿Qué tamaño de archivo puedo subir?",
  "faq.a4": "PDF Vaulty admite la mayoría de los archivos PDF estándar. Para mejores resultados, usa archivos de menos de 50 MB.",
  "faq.q5": "¿Puedo usar PDF Vaulty en móvil?",
  "faq.a5": "Sí, PDF Vaulty es totalmente responsive y funciona en smartphones, tablets y ordenadores.",
  "faq.q6": "¿Cómo fusiono varios PDFs?",
  "faq.a6": "Haz clic en la herramienta Fusionar PDF, sube dos o más archivos y haz clic en el botón Fusionar.",
  "faq.q7": "¿Funciona PDF Vaulty sin conexión?",
  "faq.a7": "PDF Vaulty requiere conexión a Internet para cargarse, pero todo el procesamiento PDF ocurre localmente en tu navegador.",
  "faq.q8": "¿A qué formatos puedo convertir PDFs?",
  "faq.a8": "Con el convertidor PDF, puedes exportar PDFs como hojas de cálculo Excel o imágenes JPG o PNG.",
  // Profile page
  ...
  "profile.toolEmpty": "Usa las herramientas PDF para ver tus estadísticas aquí.",
  ...
  "myfiles.subtitle": "Tu boveda PDF privada - cifrada y accesible solo para ti en Internet Computer.",
  ...
  "myfiles.filesPrivateFooter": "Los archivos se almacenan de forma privada en Internet Computer.",
