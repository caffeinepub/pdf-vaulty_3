import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, X, B as Button, u as useLanguage, F as FileText } from "./index-BJasp0fK.js";
import { A as AnimatePresence, m as motion } from "./proxy-DhFTxcCH.js";
import { L as Layers, M as Minimize2, F as FileInput } from "./minimize-2-Dv-xyrg9.js";
import { L as Lock } from "./lock-DLv0K-x3.js";
import { R as RotateCw } from "./rotate-cw-DsX996oH.js";
import { A as ArrowRightLeft } from "./arrow-right-left-KTWOVOjx.js";
import { H as Hash } from "./hash-CTfHihlS.js";
import { S as Stamp } from "./stamp-DMQd2jn8.js";
import { F as FileCheck } from "./file-check-CkiVvNIu.js";
import { F as FileSearch } from "./file-search-CzuhbfhM.js";
import { S as Search, T as Trash2 } from "./trash-2-BvcY9kh_.js";
import { S as Shield } from "./shield-D6x9jMUt.js";
import { Z as Zap } from "./zap-BHhqmij-.js";
/**
...
function Dashboard({ onSelectTool }) {
  ...
  const mobileTabTools = reactExports.useMemo(() => {
        ...
        children: [
          ...
          !search && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:hidden", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 mb-6 overflow-x-auto scrollbar-hide pb-1", children: MOBILE_TABS.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  onClick: () => setMobileTab(tab),
                  className: `flex-shrink-0 px-4 py-1.5 rounded-full text-sm font-semibold transition-colors ${mobileTab === tab ? "bg-blue-600 text-white" : "bg-gray-100 dark:bg-white/10 text-gray-600 dark:text-white/60 hover:bg-gray-200 dark:hover:bg-white/20"}`,
                  children: tab
                },
                tab
              )) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  "data-ocid": "dashboard.tools.list",
                  children: mobileTabTools.map((tool, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      "data-ocid": `dashboard.tools.item.${idx + 1}`,
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden sm:block", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-10", "data-ocid": "dashboard.tools.list", children: categories.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", children: category.tools.map((tool, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  "data-ocid": `dashboard.tools.item.${idx + 1}`,
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
