        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            ...
            <p className="text-sm text-vault-muted">
              Extract pages or split into individual files.
            </p>
          </div>
        </div>
        <FileUploadZone
        ...
        <div className="p-5 rounded-2xl bg-vault-surface border border-vault-border space-y-4">
          ...
          {splitMode === "specific" && (
            <div className="space-y-2">
              ...
              <p className="text-xs text-vault-muted">
                A single PDF containing only the specified pages will be
                downloaded.
              </p>
            </div>
          )}
          ...
          {splitMode === "count" && (
            <div className="space-y-2">
              ...
              {!pagesPerChunkError &&
                pagesPerChunk &&
                Number.parseInt(pagesPerChunk) >= 1 &&
                Number.parseInt(pagesPerChunk) < pageCount && (
                  <p className="text-xs text-vault-muted">
                    Will create{" "}
                    {Math.ceil(pageCount / Number.parseInt(pagesPerChunk))}{" "}
                    file(s) — each with up to {pagesPerChunk} page(s).
                  </p>
                )}
            </div>
          )}
