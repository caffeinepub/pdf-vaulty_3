const ar: Record<string, string> = {
  ...
  "faq.a4":
    "يدعم PDF Vaulty معظم ملفات PDF القياسية. للحصول على أفضل النتائج، استخدم ملفات أقل من 50 ميغابايت.",
  "faq.q5": "هل يمكنني استخدام PDF Vaulty على الجوال؟",
  "faq.a5":
    "نعم، PDF Vaulty متجاوب بالكامل ويعمل على الهواتف والأجهزة اللوحية وأجهزة الكمبيوتر.",
  ...
  "faq.a7":
    "يحتاج PDF Vaulty إلى اتصال بالإنترنت للتحميل، لكن جميع معالجة PDF تتم محليًا في متصفحك.",
