const hi = {
  ...
  "hero.subtitle": "अपनी PDF फ़ाइलों को आसानी से मर्ज, स्प्लिट, कम्प्रेस और प्रबंधित करें। सभी टूल एक जगह।",
  "hero.cta": "शुरू करें",
  ...
  "feature.secure.desc": "आपकी फ़ाइलें सुरक्षित रूप से प्रोसेस की जाती हैं और कभी साझा नहीं की जातीं",
  ...
  "login.subtitle": "अपनी PDF फ़ाइलों को आसानी से मर्ज, स्प्लिट, कम्प्रेस और प्रबंधित करें। सभी टूल एक जगह।",
  ...
  "faq.a1": "हां, PDF Vaulty पूरी तरह से मुफ़्त है। सभी PDF टूल बिना किसी शुल्क के उपलब्ध हैं।",
  "faq.q2": "क्या मेरी PDF फ़ाइलें सुरक्षित हैं?",
  "faq.a2": "आपकी फ़ाइलें पूरी तरह आपके ब्राउज़र में प्रोसेस होती हैं। हम उन्हें कभी स्टोर या शेयर नहीं करते।",
  ...
  "faq.a4": "PDF Vaulty अधिकतर मानक PDF फ़ाइलों को सपोर्ट करता है। बेहतर परिणामों के लिए 50MB से कम की फ़ाइलें उपयोग करें।",
  "faq.q5": "क्या मैं मोबाइल पर PDF Vaulty उपयोग कर सकता हूं?",
  "faq.a5": "हां, PDF Vaulty पूरी तरह रेस्पॉन्सिव है और स्मार्टफोन, टैबलेट और डेस्कटॉप पर काम करता है।",
  "faq.q6": "कई PDFs कैसे मर्ज करें?",
  "faq.a6": "Merge PDF टूल पर क्लिक करें, दो या अधिक PDF फ़ाइलें अपलोड करें, फिर Merge बटन पर क्लिक करें।",
  "faq.q7": "क्या PDF Vaulty ऑफलाइन काम करता है?",
  "faq.a7": "PDF Vaulty को लोड करने के लिए इंटरनेट कनेक्शन चाहिए, लेकिन सभी PDF प्रोसेसिंग आपके ब्राउज़र में होती है।",
  "faq.q8": "PDF को किन फॉर्मेट में बदल सकते हैं?",
  "faq.a8": "PDF Converter टूल से PDF को Excel स्प्रेडशीट या JPG/PNG इमेज के रूप में एक्सपोर्ट कर सकते हैं।",
  // Profile page
  ...
  "myfiles.subtitle": "Aapka nijee PDF vault - encrypted aur keval aapke liye, Internet Computer par surakshit.",
  ...
  "myfiles.filesPrivateFooter": "Failein Internet Computer par nijee roop se sangraheet hain.",
