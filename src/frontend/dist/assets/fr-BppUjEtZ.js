const fr = {
  ...
  "tool.crop.desc": "Recadrez les marges de chaque page de votre PDF avec précision.",
  "tool.flatten.label": "Aplatir les formulaires PDF",
  "tool.flatten.desc": "Convertissez les champs de formulaire interactifs en contenu statique non modifiable.",
  ...
  "profile.toolEmpty": "Utilisez les outils PDF pour voir vos statistiques ici.",
  ...
  "myfiles.subtitle": "Votre coffre PDF prive - chiffre et accessible uniquement par vous sur Internet Computer.",
  ...
  "myfiles.filesPrivate": "Les fichiers sont prives - seul vous pouvez y acceder",
  ...
  "myfiles.filesPrivateFooter": "Les fichiers sont stockes en prive sur Internet Computer.",
