import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, X, B as Button, u as useLanguage, F as FileText } from "./index-BqLb9sp7.js";
import { A as AnimatePresence, m as motion } from "./proxy-CO0mP2pr.js";
import { L as Layers, M as Minimize2, F as FileInput } from "./minimize-2-TdtKz4fB.js";
import { L as Lock } from "./lock-Cce50E37.js";
import { R as RotateCw } from "./rotate-cw-HPzr2a6G.js";
import { A as ArrowRightLeft } from "./arrow-right-left-gVvY9jlF.js";
import { H as Hash } from "./hash-CmGKLa22.js";
import { S as Stamp } from "./stamp-nna0Yilo.js";
import { F as FileCheck } from "./file-check-AiWfUSdB.js";
...
import { Z as Zap } from "./zap-D57qdEdo.js";
/**
  ...
  const categories = reactExports.useMemo(
    () => [
      ...
      },
      {
        label: "Convert",
        tools: allTools.filter(
          (tool) => ["image-to-pdf", "pdf-converter", "extract-text"].includes(tool.id)
        )
      },
      {
        label: "Protect",
        tools: allTools.filter(
          (tool) => ["password-protect", "flatten-pdf"].includes(tool.id)
        )
      },
      {
        label: "Optimize",
