import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, X, B as Button, u as useLanguage, F as FileText } from "./index-mB_N17VN.js";
import { A as AnimatePresence, m as motion } from "./proxy-CexQyQze.js";
import { L as Layers, M as Minimize2, F as FileInput } from "./minimize-2-Dp4tFZ3P.js";
import { L as Lock } from "./lock-CiRB-vW6.js";
import { R as RotateCw } from "./rotate-cw-oLP5J8rG.js";
import { A as ArrowRightLeft } from "./arrow-right-left-CCkYo7oH.js";
import { H as Hash } from "./hash-C0P2Y8Ua.js";
import { S as Stamp } from "./stamp-DxldTxJF.js";
import { F as FileCheck } from "./file-check-g_7-vcgG.js";
import { S as Search } from "./search-3L8oXt41.js";
import { S as Shield } from "./shield-DS3fo3Vq.js";
import { Z as Zap } from "./zap-BGbP8zNx.js";
/**
...
function Dashboard({ onSelectTool }) {
  ...
  const [recentToolIds, setRecentToolIds] = reactExports.useState([]);
  ...
  const categories = reactExports.useMemo(
    () => [
      ...
      },
      {
        label: "Convert",
        tools: allTools.filter(
          (t2) => ["image-to-pdf", "pdf-converter"].includes(t2.id)
        )
      },
      {
        label: "Protect",
        tools: allTools.filter(
          (t2) => ["password-protect", "flatten-pdf"].includes(t2.id)
        )
      },
      {
        label: "Optimize",
        tools: allTools.filter((t2) => ["compress"].includes(t2.id))
      }
    ],
    [allTools]
  );
  ...
  const recentTools = reactExports.useMemo(
    () => recentToolIds.map((id) => allTools.find((tool) => tool.id === id)).filter(Boolean),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          ...
          !search && pinnedTools.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
          ...
          !search && recentTools.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-gray-400 dark:text-white/30 mb-3", children: "Recently Used" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: recentTools.map((tool) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              ToolCard,
              {
                tool,
                isPinned: pinnedToolIds.includes(tool.id),
          ...
          !search && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-10", "data-ocid": "dashboard.tools.list", children: categories.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-gray-400 dark:text-white/30 mb-3", children: category.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: category.tools.map((tool, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                "data-ocid": `dashboard.tools.item.${idx + 1}`,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
