import { c as createLucideIcon, u as useLanguage, r as reactExports, b as useGetMyFiles, d as useSaveFile, e as useDeleteFile, j as jsxRuntimeExports, F as FileText, X, S as Share2, E as ExternalBlob, f as ue, g as useRenameFile } from "./index-CV4MT_Ao.js";
...
import { C as CircleAlert } from "./circle-alert-BFnC7Hh9.js";
import { S as Shield } from "./shield-Cw_kNPAi.js";
import { L as Lock } from "./lock-CN9wQXyV.js";
import { S as Search, T as Trash2 } from "./trash-2-Cbu_jpRQ.js";
import { E as Eye } from "./eye-D3ft2RaV.js";
import { C as Check, a as Copy } from "./copy-CIhRybql.js";
/**
...
function ShareModal({ fileName, fileUrl, onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "dialog",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-sm rounded-2xl border border-white/10 bg-[#111111] shadow-2xl p-6 flex flex-col items-center gap-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center w-full pr-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 mb-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Share2, { className: "w-4 h-4 text-blue-400" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-white", children: "Share File" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/40 truncate", title: fileName, children: fileName })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl overflow-hidden border border-white/10 bg-white p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: qrUrl,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/50 truncate", title: fileUrl, children: fileUrl }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              className: `w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg font-semibold text-sm transition-all ${copied ? "bg-green-600 text-white" : "bg-blue-600 hover:bg-blue-700 text-white"}`,
...
function MyFilesPage({
  ...
  const [sharingFile, setSharingFile] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-white dark:bg-[#0a0a0a]", children: [
    ...
    sharingFile && /* @__PURE__ */ jsxRuntimeExports.jsx(
      ShareModal,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative flex flex-col items-center justify-center text-center px-4 py-16 overflow-hidden bg-gradient-to-b from-blue-50/80 to-white dark:from-transparent dark:to-transparent dark:bg-[#0a0a0a]", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-2xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl sm:text-5xl font-black text-gray-900 dark:text-white mb-4 leading-tight tracking-tight", children: t("myfiles.title") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-gray-500 dark:text-white/60 max-w-md mx-auto leading-relaxed", children: t("myfiles.subtitle") })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: isUploading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              ...
              uploadProgress > 0 ? `${uploadProgress}%` : t("myfiles.uploading")
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 dark:text-white/30 text-sm", children: t("myfiles.loadingFiles") })
          ]
        }
      ),
      isError && !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-600 dark:text-red-400 font-semibold", children: t("myfiles.failedToLoad") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-red-400 dark:text-red-500/70 text-sm", children: t("myfiles.refreshPage") })
          ]
        }
      ),
      !isLoading && !isError && fileCount === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-800 dark:text-white/80 text-xl font-bold mb-2", children: t("myfiles.noFiles") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 dark:text-white/40 text-sm mb-3 max-w-xs leading-relaxed", children: t("myfiles.noFilesDesc") }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-8 px-4 py-2.5 rounded-xl bg-blue-50 dark:bg-blue-950/30 border border-blue-100 dark:border-blue-900/30", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-blue-600 dark:text-blue-400 font-medium", children: t("myfiles.filesPrivate") })
            ] }),
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: t("myfiles.clearSearch")
                }
              )
            ]
          }
      ...
      !isLoading && fileCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs text-gray-400 dark:text-white/25 mt-8", children: t("myfiles.filesPrivateFooter") })
    ] })
  ] });
}
export {
